...
Flockometer is an Attendance Counter application built specifically for IFGF. It helps track and store attendance counts across various services (Main Service, Kids Service) using Airtable as its backend.
